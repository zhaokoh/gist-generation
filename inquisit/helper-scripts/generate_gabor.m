%% This script is copied from https://peterscarfe.com/gabordemo.html and
%% was modified to change the position of the gabor.
...
gaborPositionOffset = OffsetRect(gaborrect, windowRect(4)/1.6, 0);
...
% for us.
Screen('DrawTextures', window, gabortex, [], gaborPositionOffset, orientation, [], [], [], [],...
